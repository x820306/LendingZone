...
router.post('/destroyTest', function(req, res, next) {
	if(typeof(req.body.ReturnID) === 'string'){
...
router.post('/pay', function(req, res, next) {
	if((typeof(req.body.ToTransaction) === 'string')&&(typeof(req.body.MoneyPaid) === 'string')){
		...
		Transactions.findById(ToTransaction).populate('Lender', 'Username Email ifMailValid').populate('Borrower', 'Username Email Level ifMailValid').populate('CreatedFrom', 'FromBorrowRequest').populate('Return').exec(function (err, transaction){
			if (err) {
				console.log(err);
				res.end("error");
			}else{
	...
	if(library.ifMail){
		if(transaction.Lender.ifMailValid){
			var mailOptions = {
				...
				text: '親愛的 '+transaction.Lender.Username+' 您好：'+String.fromCharCode(10)+String.fromCharCode(10)+'您收到了來自 '+transaction.Borrower.Username+' 在「'+transaction.CreatedFrom.FromBorrowRequest.StoryTitle+'("'+req.protocol+'://'+req.headers.host+'/lender/story?id='+transaction.CreatedFrom.FromBorrowRequest._id+'")」的還款！'+String.fromCharCode(10)+String.fromCharCode(10)+'立刻前往查看:'+String.fromCharCode(10)+'"'+req.protocol+'://'+req.headers.host+'/lender/lenderReturnRecord?oneid='+newCreate2._id+'&id=&messenger='+encodeURIComponent('不分訊息種類')+'&classor='+encodeURIComponent('不分故事種類')+'&sorter='+encodeURIComponent('建立日期')+'&director='+encodeURIComponent('大至小')+'&lbound=&ubound=&page=1"', // plaintext body
				html: '<img src="cid:cpng" /><br><br>親愛的 '+transaction.Lender.Username+' 您好：<br><br>您收到了來自 '+transaction.Borrower.Username+' 在「<a href="'+req.protocol+'://'+req.headers.host+'/lender/story?id='+transaction.CreatedFrom.FromBorrowRequest._id+'">'+transaction.CreatedFrom.FromBorrowRequest.StoryTitle+'</a>」的還款！<br><br><table cellspacing="0" cellpadding="0"><tr><td align="center" width="300" height="40" bgcolor="#000091" style="-webkit-border-radius: 5px; -moz-border-radius: 5px; border-radius: 5px; color: #ffffff; display: block;"><a href="'+req.protocol+'://'+req.headers.host+'/lender/lenderReturnRecord?oneid='+newCreate2._id+'&id=&messenger='+encodeURIComponent('不分訊息種類')+'&classor='+encodeURIComponent('不分故事種類')+'&sorter='+encodeURIComponent('建立日期')+'&director='+encodeURIComponent('大至小')+'&lbound=&ubound=&page=1" style="font-size:16px; font-weight: bold; font-family: Helvetica, Arial, sans-serif; text-decoration: none; line-height:40px; width:100%; display:inline-block"><span style="color: #FFFFFF">立刻前往查看</span></a></td></tr></table>', 
				attachments: [{
					filename: 'c.png',
		...
		if(transaction.Borrower.ifMailValid){
			var mailOptions2 = {
				from: 'LendingZone <lendingzonesystem@gmail.com>', // sender address
				...
				text: '親愛的 '+transaction.Borrower.Username+' 您好：'+String.fromCharCode(10)+String.fromCharCode(10)+'您已向 '+transaction.Lender.Username+' 支付了「'+transaction.CreatedFrom.FromBorrowRequest.StoryTitle+'("'+req.protocol+'://'+req.headers.host+'/lender/story?id='+transaction.CreatedFrom.FromBorrowRequest._id+'")」的還款！'+String.fromCharCode(10)+String.fromCharCode(10)+'立刻前往查看:'+String.fromCharCode(10)+'"'+req.protocol+'://'+req.headers.host+'/lender/lenderReturnRecord?oneid='+newCreate2._id+'&id=&messenger='+encodeURIComponent('不分訊息種類')+'&classor='+encodeURIComponent('不分故事種類')+'&sorter='+encodeURIComponent('建立日期')+'&director='+encodeURIComponent('大至小')+'&lbound=&ubound=&page=1"', // plaintext body
				html: '<img src="cid:cpng" /><br><br>親愛的 '+transaction.Borrower.Username+' 您好：<br><br>您已向 '+transaction.Lender.Username+' 支付了「<a href="'+req.protocol+'://'+req.headers.host+'/lender/story?id='+transaction.CreatedFrom.FromBorrowRequest._id+'">'+transaction.CreatedFrom.FromBorrowRequest.StoryTitle+'</a>」的還款！<br><br><table cellspacing="0" cellpadding="0"><tr><td align="center" width="300" height="40" bgcolor="#000091" style="-webkit-border-radius: 5px; -moz-border-radius: 5px; border-radius: 5px; color: #ffffff; display: block;"><a href="'+req.protocol+'://'+req.headers.host+'/lender/lenderReturnRecord?oneid='+newCreate2._id+'&id=&messenger='+encodeURIComponent('不分訊息種類')+'&classor='+encodeURIComponent('不分故事種類')+'&sorter='+encodeURIComponent('建立日期')+'&director='+encodeURIComponent('大至小')+'&lbound=&ubound=&page=1" style="font-size:16px; font-weight: bold; font-family: Helvetica, Arial, sans-serif; text-decoration: none; line-height:40px; width:100%; display:inline-block"><span style="color: #FFFFFF">立刻前往查看</span></a></td></tr></table>', 
				attachments: [{
					filename: 'c.png',
					path: __dirname+'/../public/images/c.png',
					cid: 'cpng' //same cid value as in the html img src
		...
		if((newUpdate.PrincipalNotReturn===0)&&(newUpdate.MonthPeriodLeft===0)){
			if(transaction.Lender.ifMailValid){
				var mailOptions3 = {
					...
					text: '親愛的 '+transaction.Lender.Username+' 您好：'+String.fromCharCode(10)+String.fromCharCode(10)+transaction.Borrower.Username+' 還清了所有在「'+transaction.CreatedFrom.FromBorrowRequest.StoryTitle+'("'+req.protocol+'://'+req.headers.host+'/lender/story?id='+transaction.CreatedFrom.FromBorrowRequest._id+'")」的應付款項！'+String.fromCharCode(10)+String.fromCharCode(10)+'立刻前往查看:'+String.fromCharCode(10)+'"'+req.protocol+'://'+req.headers.host+'/lender/lenderTransactionRecord?oneid='+newUpdate._id+'&filter='+encodeURIComponent('已結清')+'&messenger='+encodeURIComponent('不分訊息種類')+'&classor='+encodeURIComponent('不分故事種類')+'&sorter='+encodeURIComponent('建立日期')+'&director='+encodeURIComponent('大至小')+'&lbound=&ubound=&page=1"', // plaintext body
					html: '<img src="cid:apng" /><br><br>親愛的 '+transaction.Lender.Username+' 您好：<br><br>'+transaction.Borrower.Username+' 還清了所有在「<a href="'+req.protocol+'://'+req.headers.host+'/lender/story?id='+transaction.CreatedFrom.FromBorrowRequest._id+'">'+transaction.CreatedFrom.FromBorrowRequest.StoryTitle+'</a>」的應付款項！<br><br><table cellspacing="0" cellpadding="0"><tr><td align="center" width="300" height="40" bgcolor="#000091" style="-webkit-border-radius: 5px; -moz-border-radius: 5px; border-radius: 5px; color: #ffffff; display: block;"><a href="'+req.protocol+'://'+req.headers.host+'/lender/lenderTransactionRecord?oneid='+newUpdate._id+'&filter='+encodeURIComponent('已結清')+'&messenger='+encodeURIComponent('不分訊息種類')+'&classor='+encodeURIComponent('不分故事種類')+'&sorter='+encodeURIComponent('建立日期')+'&director='+encodeURIComponent('大至小')+'&lbound=&ubound=&page=1" style="font-size:16px; font-weight: bold; font-family: Helvetica, Arial, sans-serif; text-decoration: none; line-height:40px; width:100%; display:inline-block"><span style="color: #FFFFFF">立刻前往查看</span></a></td></tr></table>', 
					attachments: [{
						filename: 'a.png',
			...
			if(transaction.Borrower.ifMailValid){
				var mailOptions4 = {
					...
					text: '親愛的 '+transaction.Borrower.Username+' 您好：'+String.fromCharCode(10)+String.fromCharCode(10)+'您還清了所有在「'+transaction.CreatedFrom.FromBorrowRequest.StoryTitle+'("'+req.protocol+'://'+req.headers.host+'/lender/story?id='+transaction.CreatedFrom.FromBorrowRequest._id+'")」應向 '+transaction.Lender.Username+' 支付的款項！'+String.fromCharCode(10)+String.fromCharCode(10)+'立刻前往查看:'+String.fromCharCode(10)+'"'+req.protocol+'://'+req.headers.host+'/lender/lenderTransactionRecord?oneid='+newUpdate._id+'&filter='+encodeURIComponent('已結清')+'&messenger='+encodeURIComponent('不分訊息種類')+'&classor='+encodeURIComponent('不分故事種類')+'&sorter='+encodeURIComponent('建立日期')+'&director='+encodeURIComponent('大至小')+'&lbound=&ubound=&page=1"', // plaintext body
					html: '<img src="cid:apng" /><br><br>親愛的 '+transaction.Borrower.Username+' 您好：<br><br>您還清了所有在「<a href="'+req.protocol+'://'+req.headers.host+'/lender/story?id='+transaction.CreatedFrom.FromBorrowRequest._id+'">'+transaction.CreatedFrom.FromBorrowRequest.StoryTitle+'</a>」應向 '+transaction.Lender.Username+' 支付的款項！<br><br><table cellspacing="0" cellpadding="0"><tr><td align="center" width="300" height="40" bgcolor="#000091" style="-webkit-border-radius: 5px; -moz-border-radius: 5px; border-radius: 5px; color: #ffffff; display: block;"><a href="'+req.protocol+'://'+req.headers.host+'/lender/lenderTransactionRecord?oneid='+newUpdate._id+'&filter='+encodeURIComponent('已結清')+'&messenger='+encodeURIComponent('不分訊息種類')+'&classor='+encodeURIComponent('不分故事種類')+'&sorter='+encodeURIComponent('建立日期')+'&director='+encodeURIComponent('大至小')+'&lbound=&ubound=&page=1" style="font-size:16px; font-weight: bold; font-family: Helvetica, Arial, sans-serif; text-decoration: none; line-height:40px; width:100%; display:inline-block"><span style="color: #FFFFFF">立刻前往查看</span></a></td></tr></table>', 
					attachments: [{
						filename: 'a.png',
						path: __dirname+'/../public/images/a.png',
						cid: 'apng' //same cid value as in the html img src
